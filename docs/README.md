...
Las siguientes comunidades y organizaciones apoyan la iniciativa: <br>
  - El código fuente de ***COVID-19 CollaborativeTracker*** está disponible en la plataforma [Github](https://github.com/imagine-apps/COVID-19) para uso gratuito y contribución de la comunidad de desarrolladores **software abierto**. <br>

  - Colaborar con asesoramiento técnico sobre protocolos sanitarios internacionales: <br>
  ...
  - Colaborar con infraestructura y herramientas para la comunidad de desarrolladores de código abierto: <br>
    - **Github (Microsoft)** <br>
...
El cronograma de lanzamiento de nuevas versiones se puede seguir en la página web del proyecto en [https://imagine-apps.github.io/COVID-19](https://imagine-apps.github.io/COVID-19/#spanish). <br><br>
...
**Como**  <br>
Ao longo da evolução da epidemia, o software colhe informações dos **usuários-colaboradores** e exibe mapas em tempo real do **status corrente** e do **histórico de evolução** da transmissão entre humanos do COVID-19 nos transportes públicos de uma localidade. <br> <br>
...
**Como funciona**  <br>
O usuário não precisa se identificar. Ele compartilha os **locais de entrada e saída** na malha de transporte público que utiliza e informa **com que frequência** circula por esse trajeto. <br>

O usuário precisa informar também se está "sem sintomas", se "sente os sintomas, mas não tem a confirmação da contaminação" ou se é um "caso confirmado de contaminação". <br>

Enquanto houver aumento dos casos de transmissão, o usuário será convidado a confirmar essas informações **com um clique**, cada vez que receber uma notificação no telefone. <br><br>

**Mapas e gráficos**  <br>
O software traça uma série de **"mapas de calor"** e **gráficos** orientativos para leigos e especialistas, entre eles as *"rotas de maior circulação do vírus"* e o histórico da evolução do contágio nestas rotas. <br><br>

**Apoiadores**  <br>
As seguintes comunidades e organizações apoiam a iniciativa: <br>
  - O código fonte do ***COVID-19 CollaborativeTracker*** está disponível na plataforma [Github](https://github.com/imagine-apps/COVID-19) para livre utilização e contribuição da **comunidade de desenvolvedores de software aberto**. <br>
  ...
  - Colaboram com infraestrutura e ferramentas para a comunidade de desenvolvedores de software aberto: <br>
    - **Github (Microsoft)** <br>
    - **RedHat (IBM)** (contato em andamento) <br>
    - **AWS (Amazon)** (contato em andamento) <br>

  - Diversos veículos de comunicação colaboram ainda com a divulgação da iniciativa. <br><br>

**App mobile**  <br>
O projeto de desenvolvimento do software é coordenado segundo a "organização Github" **ImagineApps** que disponibiliza gratuitamente a versão estável mais recente nas *app stores* das plataformas Android e iOS.
...
**怎么** <br>
在整个流行过程中，该软件从合作用户那里收集信息，并显示本地公共交通工具上COVID-19病毒在人与人之间传播的现状和历史演变的实时地图。<br><br>

**这样** <br>
通过映射病毒的主要潜在传播轴：
  - 应用程序的用户可以跟踪其他公共交通路线，以暂时避免在具有最大传播潜力的路线上流通。
  - 公司可以为那些有最大传播潜力的路线的员工制定远程工作计划。
  - 运输公司可以投资保护那些在运输方面具有最大潜力的员工，以减少对车队运营的经济影响。
  - 卫生官员可以访问数据以更有效地计划其护理意识运动，以防止传播并减少疾病的负面影响。 <br> <br>

**运作方式** <br>
用户不需要标识自己。他只需要共享他使用的公共交通网络中的出入口地点，并估算他沿着这条路线旅行的频率。 <br>

用户仍然需要告知他是否“没有症状”，是否“感觉到症状但尚未确认污染”或是否为“确诊病例”。 <br>

在流行过程中，每次用户通过电话收到通知时，都会要求用户单击一次更新此信息。<br> <br>

**地图和图表** <br>
该软件为外行和专家绘制了一系列热图和图形指南，其中包括“病毒传播最大的路线”以及这些路线上传染性演变的历史。 <br> <br>

**支持者** <br>
以下社区和组织支持该计划：<br>
  - 平台 [Github](https://github.com/imagine-apps/COVID-19) 上提供了 COVID-19 CollaborativeTracker的源代码，可从开放软件开发人员社区免费使用和贡献。 <br><br>

  - 与有关国际卫生规程的技术建议合作：<br>
    - Hospital Albert Eisntein（正在进行中）<br>
    - 卫生部COVID-19技术监测委员会（正在进行中）<br>
    - 监视圣保罗州COVID-19的技术委员会（正在进行中）<br>

  - 与开放源码开发者社区的基础架构和工具协：<br>
    - **Github（Microsoft)** <br>
    - **RedHat（IBM)**（正在联系中）<br>
    - **AWS（Amazon)**（正在进行中）<br>

    - 一些传播工具也与倡议的传播合作。<br> <br>

**行动应用程式** <br>
该软件开发项目是根据“ Github组织”“ ImagineApps”进行协调的，该组织在Android和iOS平台“应用商店”上免费提供最新的稳定版本。

新版本的发布时间表可以在该项目的网站上找到 [https://imagine-apps.github.io/COVID-19](https://imagine-apps.github.io/COVID-19/#chinese). <br><br>
